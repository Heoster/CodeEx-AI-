          ...
          <Card>
            ...
            <CardContent>
              <div className="bg-muted p-3 rounded-lg font-mono text-sm">
                https://soham-ai.vercel.app/api/v1
              </div>
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-4">
          <CodeExampleCard
            ...
            language="javascript"
            code={`const response = await fetch('https://soham-ai.vercel.app/api/v1/chat/completions', {
  method: 'POST',
  headers: {
    'Authorization': 'Bearer YOUR_API_KEY',
...
url = "https://soham-ai.vercel.app/api/v1/chat/completions"
headers = {
    "Authorization": "Bearer YOUR_API_KEY",
    "Content-Type": "application/json"
}
...
print(result["data"]["content"])`}
          ...
          <CodeExampleCard
            title="cURL"
            language="bash"
            code={`curl -X POST https://soham-ai.vercel.app/api/v1/chat/completions \\
